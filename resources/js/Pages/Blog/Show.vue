...
const structuredData = {
    ...
    "image": props.post.featured_image ? [`${window.location.origin}/storage/${props.post.featured_image}`] : [],
                    ...
                    <div class="bg-gray-50 rounded-3xl p-8 sm:p-12 flex flex-col sm:flex-row items-center gap-8 text-center sm:text-left">
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-center sm:justify-start gap-4">
                                <a :href="'https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(window.location.href)" target="_blank" class="w-12 h-12 bg-[#1877F2] text-white rounded-xl flex items-center justify-center hover:scale-110 transition-transform">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                                <a :href="'https://twitter.com/intent/tweet?url=' + encodeURIComponent(window.location.href)" target="_blank" class="w-12 h-12 bg-[#1DA1F2] text-white rounded-xl flex items-center justify-center hover:scale-110 transition-transform">
                                    <i class="fab fa-twitter"></i>
                                </a>
                                <a :href="'https://api.whatsapp.com/send?text=' + encodeURIComponent(post.title + ' ' + window.location.href)" target="_blank" class="w-12 h-12 bg-[#25D366] text-white rounded-xl flex items-center justify-center hover:scale-110 transition-transform">
