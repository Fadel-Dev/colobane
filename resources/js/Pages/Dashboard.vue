...
.custom-grid {
    ...
    /* First column 10%, second column 90% */
}
...
<template>
    <AppLayout title="Dashboard">
        ...
        <div class="custom-grid  w-[95%] mx-auto ">
            ...
            <div v-show="activeTab === 'dashboard'" class="bg-gray-100">
                <div class="px-6 pt-6 2xl:container">
                    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        <div class="md:col-span-2 lg:col-span-1" @click="activeTab = 'immobiliers'">
                            <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                                ...
                                <div>
                                    <h5 class="text-xl text-gray-600 text-center">Publications Immobiliere</h5>

                                    <div class="mt-2 flex justify-center gap-4">
                                        <h3 class="text-3xl font-bold text-gray-700">{{ totalImmobilier }}</h3>
                                    ...
                                    <span
                                        class="block text-center bg-gradient-to-r from-principal to-secondaire text-white">Voir
                                        les Articles</span>
                                </div>
                                <table class="w-full text-gray-600">
                                    <tbody>
                                        <tr>
                                            <td class="py-2">chiffre d affaire</td>
                                            <td class="text-green-500">{{ sommeHabitatVendu }} <span
                                                    class="text-red-300">Fcfa</span></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="py-2">Vendu</td>
                                            <td class="text-gray-500">{{ totalImmobilierVendu }}</td>
                                            <td>
                                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
                                        ...
                                        <tr>
                                            <td class="py-2">Restant</td>
                                            <td class="text-gray-500">{{ restantImmobilier }}</td>
                                            <td>
                                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
                        ...
                        <div>
                            <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                                <h5 class="text-xl text-gray-700">Cher (e) {{ $page.props.auth.user.name }}</h5>
                                <div class="my-8">
                                    <h1 class="text-5xl font-bold text-gray-800">{{ total }} Article</h1>
                                    <span class="text-gray-500"> depuis le debut</span>
                                </div>
                                <div>
                                    <h5 class="text-xl text-gray-600 text-center">Chiffre d affaire</h5>
                                    <div class="mt-2 flex justify-center gap-4">
                                        <h3 class="text-3xl font-bold text-gray-700">{{ totalVenduSomme }}
                                            <span>Fcfa</span>
                                        </h3>

                                    </div>
                                    <!-- <span class="block text-center text-principal">Voir les Articles</span> -->
                                </div>
                                ...
                                <table class="mt-6 -mb-2 w-full text-gray-600">
                                    <tbody>
                                        <tr>
                                            <td class="py-2">Total Vendu</td>
                                            <td class="text-gray-500"><span class="">+</span> {{ totalVendu }}</td>
                                            <td>
                                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
                                        ...
                                        <tr>
                                            <td class="py-2">Vente en cours </td>
                                            <td class="text-gray-500"> <span class="text-green-500">+</span>{{
                                                totalRestant }}
                                            </td>
                                            <td>
                                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none"
                            ...
                            <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                                <svg class="w-40 m-auto" viewBox="0 0 56 56" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="url(#paint0_linear_622:13696)" stroke-width="5"
                                        stroke-linecap="round" />
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_622:13696" x1="5.54791e-07" y1="42.0001"
                                            ...
                                            <stop stop-color="#eb2d53" />
                                            <stop offset="1" stop-color="#7517F8" />
                                        </linearGradient>
                                    </defs>
                                </svg>
                                <div class="mt-6">
                                    <h5 class="text-xl text-gray-700 text-center">Publications Voiture</h5>

                                    <div class="mt-2 flex justify-center gap-4">
                                        <h3 class="text-3xl font-bold text-gray-700">+{{ totalVehicule }} </h3>
                                        <div class="flex items-end gap-1 text-green-500">
                                            <svg class="w-3" viewBox="0 0 12 15" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor" />
                                ...
                                <table class="mt-6 -mb-2 w-full text-gray-600">
                                    <tbody>
                                        <tr>
                                            <td class="py-2">Chiffre d affaire</td>
                                            <td class="text-green-500">+{{ sommeVehiculeVendu }} <span
                                                    class="text-red-300">Fcfa</span></td>
                                            <td>
                                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <tr>
                                            <td class="py-2">Vendu Voiture</td>
                                            <td class="text-gray-500">{{ totalVehiculeVendu }}</td>
                                            <td>
                                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
                                        ...
                                        <tr>
                                            <td class="py-2">Restant </td>
                                            <td class="text-grey-500">{{ restantVoiture }}</td>
                                            <td>
                                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
                                    ...
                                    <div class="flex items-center space-x-4 justify-between">
                                        <div class="flex flex-row space-x-1">
                                            ...
                                            <div
                                                ...
                                                <span @click="navigateUpdateVehicule(vehicule.id)">modifier</span>
                                            </div>
            ...
            <div v-show="activeTab === 'immobiliers'" class="bg-gray-100">
                ...
                <div class="immo lg:w-9/12  mx-auto text-gray-800">
                    ...
                    <div class="flex flex-wrap justify-center mt-20">
                        <div v-for="habitat in habitats" :key="habitat.id"
                            class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 p-2">
                            <div class="bg-secondaire text-center rounded-2xl shadow-2xl relative mt-4">
                                <img :src="'/storage/' + habitat.image1" :alt="habitat.imageAlt"
                                    class="w-full h-full object-fill rounded-2xl shadow-lg">
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="text-principal text-lg">{{ habitat.prix }}<span
                                            class="text-principal text-opacity-60"> Fcfa</span></p>
                                    <div class="flex items-center space-x-4 justify-between">
                                        <div class="flex flex-row space-x-1">
                                            <div
                                                class=" bg-green-500 shadow-md shadow- shadow-green-600 text-white cursor-pointer px-[3%] text-center justify-center items-center rounded-xl flex space-x-2 flex-row">
