...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                        ...
                        <span class="block text-center bg-gradient-to-r from-principal to-secondaire text-white">Voir les Articles</span>
                    </div>
                    <table class="w-full text-gray-600">
                        <tbody>
                            <tr>
                                <td class="py-2">chiffre d affaire</td>
                                <td class="text-green-500">{{ sommeHabitatVendu }} <span class="text-red-300">Fcfa</span></td>
                                <td>
            ...
            <div>
                <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold text-gray-700">{{ totalVenduSomme }} <span>Fcfa</span></h3>
                    ...
                    <table class="mt-6 -mb-2 w-full text-gray-600">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-gray-500"> <span class="text-green-500">+</span>{{ totalRestant }}</td>
                                <td>
                                    <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                                        <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
                ...
                <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                    ...
                    <table class="mt-6 -mb-2 w-full text-gray-600">
                        <tbody>
                            <tr>
                                <td class="py-2">Chiffre d affaire</td>
                                <td class="text-green-500">+{{ sommeVehiculeVendu}} <span class="text-red-300">Fcfa</span></td>
                                <td>
                                    <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                                        <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
