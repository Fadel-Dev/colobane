            ...
            <div class="container mx-auto">
                <div class="md:flex md:items-center">
                    ...
                    <div
                        ...
                        <!-- Left Arrow -->
                        <i class="p-2 bg-transparent text-3xl rounded text-white bi bi-chevron-left absolute top-1/2 left-11"
                            @click="previousImage"></i>
                        <!-- Main Image -->
                        <img class="w-full h-full" :src="'/' + currentImage">
                        <!-- Right Arrow -->
                        <i class="p-2 text-4xl text-white rounded bi bi-chevron-right absolute top-1/2 right-11"
                            @click="nextImage"></i>
                    </div>
                                ...
                                <div v-if="afficherPopup"
                                    ...
                                    <div class="bg-white rounded-lg p-8">
                                        ...
                                        <span class="text-3xl">Évitez les demandes de paiement anticipé : Soyez prudents
                                            face aux demandes de paiement anticipé avant d'avoir reçu le produit ou
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            ...
                            <div v-for="suggestion in suggestions" :key="suggestion.id"
                                ...
                                <img :src="'/' + suggestion.image1" alt="Produit" class="w-full h-auto mb-2 rounded-lg">
