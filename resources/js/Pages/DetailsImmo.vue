      ...
      <main class="my-6 lg:pl-[10%] flex justify-center">
        <div class="container mx-auto">
          <div class="md:flex md:items-center">
            ...
            <div
              ...
              <img :src="'/storage/' + currentImage"
                class="w-auto h-full object-cover transition-all duration-300 ease-in-out" alt="Carrousel image">
            ...
            <div
              ...
              <div class="head flex">
                ...
                <span class="text-gray-400 mt-3 px-3">Proposé par <span class="text-gray-300 uppercase">{{ nameSeler
                    }}</span></span>
              </div>
              <hr class="my-3">
              ...
              <div v-if="maison.type == 'villa' || maison.type == 'appartement' || maison.type == 'chambre'">
                <span class="text-gray-500 mt-3">Lieu : <span class="text-gray-700 uppercase">{{ maison.region
                    }}</span></span><br>
                <span class="text-gray-500 mt-3">Piece : <span class="text-gray-700 uppercase">{{ maison.npiece
                    }}</span></span><br>
                ...
                <div>
                  ...
                  <div v-if="afficherPopup"
                    ...
                    <div class="bg-white rounded-lg p-8">
                      ...
                      <span class="text-3xl">Évitez les demandes de paiement anticipé : Soyez prudents face aux demandes
                        de paiement anticipé avant d'avoir reçu le produit ou visité la propriété. Les vendeurs
                        légitimes seront compréhensifs envers vos préoccupations</span><br>
                      <span class="text-3xl"><span class="text-principal">Numéro du Vendeur</span>: {{ phoneSeler
                        }}</span>
          ...
          <div
            ...
            <span class="text-gray-500 mt-3">Prix : <span class="text-principal uppercase">{{ maison.prix }}</span>
              Fcfa</span><br>
            <hr>
        ...
        <div v-if="afficherPopup" class="w-11/12 mx-auto fixed inset-0 flex justify-center bg-gray-800 bg-opacity-75">
          <div class="bg-white rounded-lg p-8">
            ...
            <span class="text-1xl text-black">Évitez les demandes de paiement anticipé : Soyez prudents face aux
              demandes de paiement anticipé avant d'avoir reçu le produit ou visité la propriété. Les vendeurs légitimes
              seront compréhensifs envers vos préoccupations</span>
            <br>
            <br>
            <hr>
            <span class="text-1xl text-black">Numero du Vendeur</span><span class="text-principal">:{{ phoneSeler
              }}</span>
            <button @click="fermerPopup"
