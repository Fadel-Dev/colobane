...
<template>
    ...
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full h-screen" id="main">
           ...
           <h2 class="text-principal text-center text-3xl w-1/5 mx-auto mt-10">
            Noflay
           </h2>
            </div>
...
<div>
            ...
            <div class="flex items-center justify-end mt-4">
                <Link :href="route('login')" class="underline text-sm text-gray-600  hover:text-principal rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Already registered?
                </Link>

                <PrimaryButton class="ml-4 bg-principal hover:border-2 hover:border-principal  hover:bg-secondaire hover:text-principal " :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Register
                </PrimaryButton>
            </div>
        </form>
