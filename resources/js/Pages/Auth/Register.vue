                    ...
                    <div class="w-full lg:w-7/12 p-6 sm:p-12 lg:p-16 flex flex-col justify-center">
                        <div class="max-w-md mx-auto w-full">
                            ...
                            <form @submit.prevent="submit" class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input
                                                ...
                                                placeholder="••••••••"
                                                class="w-full px-5 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-principal/10 focus:border-principal transition-all duration-200"
                                                :class="{ 'border-red-500 bg-red-50': form.errors.password_confirmation || (form.password_confirmation && !passwordsMatch) }"
                                            />
                                            <button type="button" @click="showPasswordConfirmation = !showPasswordConfirmation" class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-secondaire">
                                                <svg v-if="!showPasswordConfirmation" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                                <svg v-else class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.906 5.236m-11.274 0L3 21" /></svg>
                                            </button>
                                        </div>
                                        <p v-if="form.password_confirmation && !passwordsMatch" class="mt-1.5 text-xs text-red-600 font-medium">Les mots de passe ne correspondent pas</p>
                                    </div>
                                ...
                                <button
                                    type="submit"
                                    :disabled="form.processing || !form.terms || !isPasswordStrong || !form.password_confirmation || form.password !== form.password_confirmation"
