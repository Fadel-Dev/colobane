...
<template>
    ...
    <h2 class="text-principal text-center text-4xl  mx-auto mt-2">
            Noflay
           </h2>
...
<!-- Phone -->
 <div class="lg:grid grid-cols-3 gap-2">
    ...
    text-center bg-principal hover:bg-secondaire" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                   S inscrire
                </PrimaryButton>
                </div>
                <div class="mt-2">
                     <Link :href="route('login')" class=" text-sm text-gray-600  hover:text-principal rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                   Deja un Compte ?  <span class="text-principal hover:underline"> Se connecter</span> 
                </Link>
                </div>
