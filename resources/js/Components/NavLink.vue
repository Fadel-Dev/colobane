...
const classes = computed(() => {
    return props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-[2px] border-principal text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-principal transition duration-350 ease-in-out'
