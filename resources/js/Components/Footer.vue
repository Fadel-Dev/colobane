  ...
  <div class="container mx-auto px-4">
    <div class="flex flex-wrap justify-between">
      <div class="w-full md:w-1/4 mb-4 md:mb-0">
        <h2 class="text-xl text-white font-semibold mb-4">À propos de nous</h2>
      ...
      <div class="w-full md:w-1/4 mb-4 md:mb-0">
        <h2 class="text-xl text-white font-semibold mb-4">Liens utiles</h2>
        <ul class="list-none">
      ...
      <div class="w-full md:w-1/4 mb-4 md:mb-0">
        <h2 class="text-xl text-white font-semibold mb-4">Contactez-nous</h2>
        <ul class="list-none">
      ...
      <div class="w-full md:w-1/4 mb-4 md:mb-0">
        <h2 class="text-xl text-white font-semibold mb-4">Suivez-nous</h2>
    ...
    <div class="w-full">
        <p class="text-center text-gray-400 text-sm">&copy; 2023 en prod - Tous droits réservés</p>
      </div>
    </div>
  </div>
</footer>
